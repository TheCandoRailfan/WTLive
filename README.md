...
1. Basic Operation:
 ...
 - When the program opens, enter a valid stop number into the appropriate textbox. Stop numbers can be found on the Winnipeg Transit (WT) website, and on WT bus stop signs.
...
The list of departures shows several pieces of information about each departure. They are as follows, from left to right:
 - ETA: This is the estimated time that the bus will arrive at. It can be shown as either "hh:mm" or "n Min(s)".
...
As you probably noticed, the Stop Number is not the only option that you can set. There are other optional settings you can set below it. They are as follows:
 ...
 - Mins to Arrival: If checked, it will change how the ETA is shown. For example, if it is 9:24 and a bus is coming at 9:27, it'll show "3 Mins" instead of "09:27". It will only do this for future departures less than 60 minutes ahead.
 ...
 - Full Screen: If you click the "Full Screen" button, then the departure list will be shown in full screen. You can exit full screen by double-clicking the departure list.
